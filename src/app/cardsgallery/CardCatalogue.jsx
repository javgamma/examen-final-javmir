...
const CardCatalogue = ({ id, brand, img, price, available }) => {
  return (
    <div
      className={`flex flex-col items-center justify-center text-center gap-6 w-[250px] m-2 h-[391px] border rounded-lg hover:shadow-xl border-solid border-[#e3ded7] ${
        !available ? "opacity-40" : ""
      }`}
    >
      <Image src={img} width={200} height={200}  alt="coffe img"/>
