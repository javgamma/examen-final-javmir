...
const DigitalClock = () => {
   ...
   return (
    //   <div className='bg-gradient-to-r from-gray-100 to-zinc-100  text-white min-h-screen w-full flex items-center justify-center '>
    //      <div className='text-center border-[4px] border-blue-600  rounded-lg p-4 bg-blue-800 flex flex-col justify-items-center'>
